...
require '../conn.php';
// Show overview
	$result = mysqli_query($conn,"SELECT * FROM payable");
echo "<h2 class='table_title' id='overview'>Accounts payable</h2>
<div class='wrapper'>
<div class='table'>
...
{
echo "<div class='row'>";
echo "<a class='capbtn' href='#" . $row['name'] . "'><div class='cell'>" . $row['name'] . "</div></a>";
echo "<div class='cell'>" . $row['amount'] . "</div>";
echo "</div>";
}
	$sqlTotal = "SELECT SUM(amount) FROM payable";
...
echo "<h2 class='table_title' id='" . $row['name'] . "'>" . $row['name'] . "</h2>
<div class='wrapper'>
<div class='table'>
<div class='row header'>
